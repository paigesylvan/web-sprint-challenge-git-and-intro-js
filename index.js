...
function removeArtist(array, index) {
  let newArr = array.filter(artist => artist.id != index);
  return newArr
};
...
console.log(addArtist(artists, "paige", "2000 - today", "Web Design", "American", "I am learning to code. Right now using Javascript."));
...
function artistByCountry(array, string) {
  const newArr = array.filter((artists) => artists.nationality === string);
